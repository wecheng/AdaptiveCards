    ...
    public:
       ...
       TEST_METHOD(DuplicateFallbackIdSimple)
        ...
        TEST_METHOD(RequiresAndFallbackSerialization)
        {
            ...
            auto serializedCard = card->Serialize();
            Assert::AreEqual(serializedCard.c_str(),
                R"({"actions":[],"body":[{"fallback":{"text":"This element has no version requirement","type":"TextBlock"},"requires":{"foobar":"2.0.0.0","version":"1.2.0.0"},"text":"This element requires version 1.2","type":"TextBlock"}],"type":"AdaptiveCard","version":"1.2"}
)");
        }
    };
}
