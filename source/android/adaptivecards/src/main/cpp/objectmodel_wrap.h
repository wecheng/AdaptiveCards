...
public:
    ...
    SwigDirector_ActionElementParser(JNIEnv *jenv, AdaptiveCards::ActionElementParser const &arg0);
    SwigDirector_ActionElementParser(JNIEnv *jenv, AdaptiveCards::ActionElementParser &&arg0);
...
public:
    ...
    SwigDirector_BaseCardElementParser(JNIEnv *jenv, AdaptiveCards::BaseCardElementParser const &arg0);
    SwigDirector_BaseCardElementParser(JNIEnv *jenv, AdaptiveCards::BaseCardElementParser &&arg0);
